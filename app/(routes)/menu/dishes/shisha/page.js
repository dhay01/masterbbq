...
export default function Shisha() {
    // Find the category with id=10 (Shisha)
                    ...
                    <div className="grid grid-cols-1 gap-4"> {/* Grid container */}
                        {subcategories && subcategories.map((subcategory) => (
                            <div key={subcategory.id}>
                                <h2 className="text-2xl font-semibold mt-4 mb-2 text-gray-400 text-center">{subcategory.name}</h2> {/* Centered title with gray color */}
                                <div className="grid grid-cols-1 gap-4"> {/* Grid container for shishas */}
