...
export default function BoxMeal() {
    ...
    const boxMealCategory = menu.find((category) => category.category_id === "1");
    ...
    if (boxMealCategory) {
        return (
            <div>
                <main className="">
                <div className="hero" style={{backgroundImage: `url(/images/${boxMealCategory.category_photo})`, minHeight: '600px'}}>
                    <div className="hero-overlay bg-opacity-60"></div>
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-md">
                            <h1 className="mb-5 text-5xl text-white font-bold">{boxMealCategory.category_name}</h1>
                        </div>
                    </div>
                </div>
            </main>
                <div className="container mx-auto px-4 py-8">
                    <div className="flex justify-center pt-10">
                        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-x-40 gap-y-20">
                            {boxMealCategory.dishes.map((dish) => (
