...
export default function Contact() {
    return (
        <footer className="footer contact bg-base-100 mb-10 text-right p-8 md:p-10 text-lg text-white/70  flex flex-wrap md:flex-nowrap  justify-between">
            ...
            <aside className="w-full md:w-72 mb-6 md:mb-0 md:mr-6">
                <iframe
                    ...
                    width="100%" height="250" style={{ borderRadius: '0',  }} allowFullScreen="" loading="lazy"
